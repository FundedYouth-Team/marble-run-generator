    ...
    project: [
      {
        ...
        rows: [
          ...
          {
            keys: ['Export'],
            action: 'Open the export window, in the top bar beside New',
            note: 'printable files, not a project you can reopen; Esc closes it',
          },
          {
            keys: ['Type'],
            action: 'What that window writes — pick it first',
            note: 'Separate Parts lays every part flat on one plate for the slicer, Assembly keeps the run as designed for checking fit, Selected Part writes just the part you have clicked; hover any of the three to see what it does',
          },
          {
            keys: ['File format'],
            action: 'STL, 3MF or OBJ — then the file name',
            note: 'STL cannot keep parts apart, so it is greyed out for Separate Parts; 3MF and OBJ carry all three types',
          },
        ],
      },
      {
