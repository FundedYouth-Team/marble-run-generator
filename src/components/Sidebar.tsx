  ...
  return (
    <aside className="sidebar">
      <section className="panel">
        <h2>
          <span className="step">1</span> Tube Front Face
        </h2>
        <NumberField
      ...
      <section className="panel">
        <h2>
          <span className="step">2</span> Object
        </h2>
        <label className="field">
          <span className="field-label">Type</span>
          <select defaultValue="straight">
            <option value="straight">Straight Line</option>
            <option value="curve" disabled>
              Curve — coming soon
            </option>
            <option value="drop" disabled>
              Drop — coming soon
            </option>
          </select>
        </label>
        ...
        <div className="piece-list">
            ...
            return (
              <div key={p.id} className={`piece ${on ? 'on' : ''}`}>
                <button className="piece-head" onClick={() => s.select(on ? null : p.id)}>
                  ...
                  <span className="piece-name">Straight Line</span>
          ...
          {!s.pieces.length && <p className="note">No pieces yet — add a straight line.</p>}
        </div>
      ...
      <section className="panel">
        <h2>
          <span className="step">3</span> Marble &amp; Simulator
        </h2>
        <NumberField
